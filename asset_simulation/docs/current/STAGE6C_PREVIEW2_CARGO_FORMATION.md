...
但 Preview2 也不会把所有油机械赶向当前最便宜来源。本轮来源重配有显式预算，并采用固定小步调整；自然计划仍然提供贸易结构惯性。
...
默认单轮最多重配 natural total 的 30%，防止双来源 Preview 因缺少真实原油品种、长期合同等摩擦而瞬间把全部贸易流冲到一边。这个预算是 Preview2 的透明实验边界，不是现实经验比例。
