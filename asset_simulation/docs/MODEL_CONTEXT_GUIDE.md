...
| 原油短期预测 | `current/OIL_SHORT_TERM_FORECAST.md` + Commodity Layer | `model/oil_short_term_forecast.py`、`config/oil_short_term_forecast_v0.1.json`、`contracts/oil_short_term_forecast_v1.json` |
