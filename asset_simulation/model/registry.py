...
OIL_SHORT_TERM_FORECAST_CONFIG_PATH = PACKAGE_ROOT / "config" / "oil_short_term_forecast_v0.2.json"
OIL_SHORT_TERM_FORECAST_CONTRACT_PATH = PACKAGE_ROOT / "contracts" / "oil_short_term_forecast_v2.json"
OIL_STRATEGY_RESEARCH_CONFIG_PATH = PACKAGE_ROOT / "config" / "oil_strategy_research_v0.2.json"
OIL_STRATEGY_RESEARCH_CONTRACT_PATH = PACKAGE_ROOT / "contracts" / "oil_strategy_research_v2.json"
OIL_CALENDAR_SPREAD_STRATEGY_CONFIG_PATH = PACKAGE_ROOT / "config" / "oil_calendar_spread_strategy_v0.1.json"
OIL_CALENDAR_SPREAD_STRATEGY_CONTRACT_PATH = PACKAGE_ROOT / "contracts" / "oil_calendar_spread_strategy_v1.json"
OIL_EXECUTION_DESK_CONFIG_PATH = PACKAGE_ROOT / "config" / "oil_execution_desk_v0.2.json"
OIL_EXECUTION_DESK_CONTRACT_PATH = PACKAGE_ROOT / "contracts" / "oil_execution_desk_v2.json"
CORPORATE_RISK_CONTROL_CONFIG_PATH = PACKAGE_ROOT / "config" / "corporate_risk_control_v0.2.json"
CORPORATE_RISK_CONTROL_CONTRACT_PATH = PACKAGE_ROOT / "contracts" / "corporate_risk_control_v2.json"
OIL_STRATEGY_RISK_CONFIG_PATH = PACKAGE_ROOT / "config" / "oil_strategy_risk_v0.1.json"
OIL_STRATEGY_RISK_CONTRACT_PATH = PACKAGE_ROOT / "contracts" / "oil_strategy_risk_v1.json"
OIL_TRADING_STRATEGY_CONFIG_PATH = PACKAGE_ROOT / "config" / "oil_trading_strategy_v1.2.json"
OIL_TRADING_STRATEGY_CONTRACT_PATH = PACKAGE_ROOT / "contracts" / "oil_trading_strategy_v8.json"
OIL_FUTURES_ACCOUNT_CONFIG_PATH = PACKAGE_ROOT / "config" / "oil_futures_account_v0.1.json"
OIL_FUTURES_ACCOUNT_CONTRACT_PATH = PACKAGE_ROOT / "contracts" / "oil_futures_account_v1.json"
INSTITUTION_ORGANIZATION_CONFIG_PATH = PACKAGE_ROOT / "config" / "institution_organization_v0.1.json"
INSTITUTION_ORGANIZATION_CONTRACT_PATH = PACKAGE_ROOT / "contracts" / "institution_organization_v1.json"
INVESTMENT_DECISION_CONFIG_PATH = PACKAGE_ROOT / "config" / "investment_decision_v0.1.json"
INVESTMENT_DECISION_CONTRACT_PATH = PACKAGE_ROOT / "contracts" / "investment_decision_v1.json"
OIL_SHORT_HORIZON_RISK_CONFIG_PATH = PACKAGE_ROOT / "config" / "oil_short_horizon_risk_v0.1.json"
OIL_SHORT_HORIZON_RISK_CONTRACT_PATH = PACKAGE_ROOT / "contracts" / "oil_short_horizon_risk_v1.json"
...
def load_registered_assets() -> dict[str, Any]:
    ...
    oil_calendar_spread_strategy_config = load_json(OIL_CALENDAR_SPREAD_STRATEGY_CONFIG_PATH)
    oil_calendar_spread_strategy_contract = load_json(OIL_CALENDAR_SPREAD_STRATEGY_CONTRACT_PATH)
    ...
    institution_organization_config = load_json(INSTITUTION_ORGANIZATION_CONFIG_PATH)
    institution_organization_contract = load_json(INSTITUTION_ORGANIZATION_CONTRACT_PATH)
    investment_decision_config = load_json(INVESTMENT_DECISION_CONFIG_PATH)
    investment_decision_contract = load_json(INVESTMENT_DECISION_CONTRACT_PATH)
    oil_short_horizon_risk_config = load_json(OIL_SHORT_HORIZON_RISK_CONFIG_PATH)
    oil_short_horizon_risk_contract = load_json(OIL_SHORT_HORIZON_RISK_CONTRACT_PATH)
    return {
        "config": config,
        ...
        "oil_short_term_forecast_config_hash": sha256_json(oil_short_term_forecast_config),
        "oil_short_term_forecast_contract": oil_short_term_forecast_contract,
        "oil_short_term_forecast_contract_hash": sha256_json(oil_short_term_forecast_contract),
        "oil_strategy_research_config": oil_strategy_research_config,
        "oil_strategy_research_config_hash": sha256_json(oil_strategy_research_config),
        "oil_strategy_research_contract": oil_strategy_research_contract,
        "oil_strategy_research_contract_hash": sha256_json(oil_strategy_research_contract),
        "oil_calendar_spread_strategy_config": oil_calendar_spread_strategy_config,
        "oil_calendar_spread_strategy_config_hash": sha256_json(oil_calendar_spread_strategy_config),
        "oil_calendar_spread_strategy_contract": oil_calendar_spread_strategy_contract,
        "oil_calendar_spread_strategy_contract_hash": sha256_json(oil_calendar_spread_strategy_contract),
        ...
        "oil_trading_strategy_contract_hash": sha256_json(oil_trading_strategy_contract),
        ...
        "oil_futures_account_contract_hash": sha256_json(oil_futures_account_contract),
        "institution_organization_config": institution_organization_config,
        "institution_organization_config_hash": sha256_json(institution_organization_config),
        "institution_organization_contract": institution_organization_contract,
        "institution_organization_contract_hash": sha256_json(institution_organization_contract),
        "investment_decision_config": investment_decision_config,
        "investment_decision_config_hash": sha256_json(investment_decision_config),
        "investment_decision_contract": investment_decision_contract,
        "investment_decision_contract_hash": sha256_json(investment_decision_contract),
        "oil_short_horizon_risk_config": oil_short_horizon_risk_config,
        "oil_short_horizon_risk_config_hash": sha256_json(oil_short_horizon_risk_config),
        "oil_short_horizon_risk_contract": oil_short_horizon_risk_contract,
        "oil_short_horizon_risk_contract_hash": sha256_json(oil_short_horizon_risk_contract),
    }
